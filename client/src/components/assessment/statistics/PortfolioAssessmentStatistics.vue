<template>
  ...
  >
    <v-card-title>
      <h3 class="mx-3"><strong>Statistics:</strong></h3>
      <v-spacer></v-spacer>
      <!--  Status button    -->
...
export default Vue.extend ({
  name: "PortfolioAssessmentStatistics",
  ...
  methods: {
    ...
    async loadAssessment() {
      ...
      try {
        const response = await AssessmentStatisticsController.getStatisticsByPortfolioId (
            this.portfolioId,
